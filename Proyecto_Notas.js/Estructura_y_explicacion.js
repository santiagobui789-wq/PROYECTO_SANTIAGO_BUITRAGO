...
aprendices.forEach(a => {
    ...
    // Por ultimo tenemos el switch que sirve para la clasificacion.
    //asignamos la variable true  y empezamos hace case a cada nota. dando como
    //  resultado la clasificacion de las notas
});
